...
import Select__Overlay from "../../Select__Overlay"; // plasmic-import: hZghwjring4Q/component
import Select__Option from "../../Select__Option"; // plasmic-import: mCWiu0FddPuk/component
import Select__OptionGroup from "../../Select__OptionGroup"; // plasmic-import: DGiUTURv-ef3/component

import "@plasmicapp/react-web/lib/plasmic.css";

import projectcss from "./plasmic.module.css"; // plasmic-import: 7KycgN7CbBQrbUdWStFgm4/projectcss
import sty from "./PlasmicSelect.module.css"; // plasmic-import: hXd-xqa7wnmm/css

import ChevronDownsvgIcon from "./icons/PlasmicIcon__ChevronDownsvg"; // plasmic-import: R5Yi8lVQMzqX/icon
import ChevronUpsvgIcon from "./icons/PlasmicIcon__ChevronUpsvg"; // plasmic-import: C2Gp0j_ODpWu/icon
    ...
    if (!("children" in props)) {
      props = {
        ...
        children: (
          <React.Fragment>
            <Select__Option
              className={classNames("__wab_instance", sty.option__wzzoa)}
              value={"value1"}
            >
              {"Option 1"}
            </Select__Option>
            <Select__Option
              className={classNames("__wab_instance", sty.option__gAqSm)}
              value={"value2"}
            >
              {"Option 2"}
            </Select__Option>
