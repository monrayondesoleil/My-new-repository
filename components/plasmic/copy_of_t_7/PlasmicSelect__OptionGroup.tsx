...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: DGiUTURv-ef3/css

import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: hXd-xqa7wnmm/render
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__v8HCq)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option__qtHpx)}
              />
            </React.Fragment>
          ),
          value: args.children
